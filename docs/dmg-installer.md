...
For exact published versions, checksums and notarization results, use [release records](releases/v0.1.0-beta.5.md). The [historical build-11 installer review](releases/v0.1.0-beta.5.md#historical-beta5-installer-record--build-11) preserves the original Finder/layout and signing checks.
