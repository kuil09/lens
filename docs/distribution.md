...
- **Current source/local package:** beta.4/build 10 contains capture feedback, save-folder access, and window-return improvements. The owner authorized a regenerated local DMG and another source-history consolidation. It is not uploaded as a GitHub release; beta.3 remains the published download. See [local package notes](releases/v0.1.0-beta.4.md).
