...
- **Current development prerelease:** [v0.1.0-beta.4](https://github.com/kuil09/lens/releases/tag/v0.1.0-beta.4), app 0.1.0/build 10, contains capture feedback, save-folder access, and window-return improvements. Following local packaging and history consolidation, the owner separately authorized replacing the GitHub downloads. The DMG contains the existing Developer ID signed, nonnotarized app with identifier `dev.local.lens`. See [release notes](releases/v0.1.0-beta.4.md).
