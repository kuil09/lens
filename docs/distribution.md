...
- **Current notarized prerelease:** [v0.1.0-beta.5](https://github.com/kuil09/lens/releases/tag/v0.1.0-beta.5), app 0.1.0/build 11, adds the redesigned installer. The owner separately authorized notarization and GitHub publication; see [exact artifact evidence](dmg-installer.md) and [release notes](releases/v0.1.0-beta.5.md). Main is consolidated into one release baseline; earlier tags and release records remain. No installed app, bundle identity, or user settings were migrated. App Store work remains separate.
