...
/// Relinquish the overlay only for an explicit Lens screen-permission action.
/// Ordinary System Settings visits and language downloads must not begin a handoff.
